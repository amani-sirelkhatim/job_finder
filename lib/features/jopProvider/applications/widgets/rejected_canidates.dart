...
class rejectedCan extends StatefulWidget {
  const rejectedCan({super.key});

  @override
  State<rejectedCan> createState() => _rejectedCanState();
}

class _rejectedCanState extends State<rejectedCan> {
  @override
